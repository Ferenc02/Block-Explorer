export const showMessageBox = (
  ...
  messageBoxParent.innerHTML = `
    ...
    >
      <div
        class="message-box__content grow-animation bg-white rounded-lg mx-auto p-4 flex flex-col items-center gap-8 shadow-lg max-w-xs min-w-xs md:max-w-sm min-w-sm"
      >
        <span
